...
interface MyMaskedInputProps extends React.HTMLProps<HTMLInputElement> {
  error: string | undefined;
  id: string | undefined;
  label: string;
}

export const MyMaskedInput = forwardRef<HTMLInputElement, MyMaskedInputProps>(({label, error, id, ...props}, ref) => {
  return (
